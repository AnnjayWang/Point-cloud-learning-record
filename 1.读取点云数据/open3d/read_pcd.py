...
def read_file(file_path):
    ...
    #pc = o3d.geometry.PointCloud()  # 创建一个空的点云对象
    #pc.points = o3d.utility.Vector3dVector(np_data)
    #o3d.visualization.draw_geometries([pc], window_name = "原始点云")
...
def main():
    ...
    txt_filepath = 'E:\\深蓝学院三维点云课程\\modelnet40_normal_resampled\\airplane\\airplane_0001.txt'     # 所用txt为modelnet40, 六列数据分别为: x,y,z,nx,ny,nz。
